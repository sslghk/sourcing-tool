...
OVERVIEW
--------
This document lists all dependencies required to run the Sourcing Tool project 
on a new server and provides quick setup instructions.
...
Python         3.11                   3.11.x
Redis          6.x                    7.x
OS             Ubuntu 20.04 / Win 10  Ubuntu 22.04 LTS
RAM            4GB                    8GB+
Disk           10GB                   20GB+
...
Linux/macOS Scripts:
  setup-server.sh      - Install system dependencies (Node, Python, Redis)
  setup-project.sh     - Install project dependencies (npm, Python venv)
  start-services.sh    - Start all services with logging
  stop-services.sh     - Stop all running services

Windows PowerShell Scripts:
  Setup-Server.ps1     - Install system dependencies
  Setup-Project.ps1    - Install project dependencies
